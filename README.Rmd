...
* In the case of option 2, you have to specify the path either to the directory of **ResearchGroupTools** or to the bundled archive **ResearchGroupTools_0.3.0.tar.gz**
...
* `cumskewness()`, `cumkurtosis()`, `cumsd()` (standard deviation) and `cumadv` (average deviation) return a vector with cumulative results of the specific function. 
